...
require_once WPPDF_PATH . 'includes/class-wppdf-canonical.php';
require_once WPPDF_PATH . 'includes/class-wppdf-protection.php';
require_once WPPDF_PATH . 'includes/class-wppdf-noindex.php';
require_once WPPDF_PATH . 'includes/class-wppdf-permalinks.php';
